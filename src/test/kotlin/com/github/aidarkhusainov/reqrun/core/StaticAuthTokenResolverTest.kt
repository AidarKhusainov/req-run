...
class StaticAuthTokenResolverTest {
    ...
    fun `resolves bearer token with variables`() {
        ...
        val token = StaticAuthTokenResolver.resolveToken(
            id = "bearer",
            configs = configs,
    ...
    fun `resolves bearer header with prefix`() {
        ...
        val header = StaticAuthTokenResolver.resolveHeader(
            id = "bearer",
            configs = configs,
            variables = emptyMap(),
            builtins = emptyMap()
    ...
    fun `describeAuthIssue reports missing token`() {
        ...
        val issue = StaticAuthTokenResolver.describeAuthIssue(
            id = "bearer",
            configs = configs,
            variables = emptyMap(),
            builtins = emptyMap()
